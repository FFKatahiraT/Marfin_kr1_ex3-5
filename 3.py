...
plotter(t[lenght:], [P[lenght:]], r'$t$ [s]', r'$dP_c$($t$) [Pa]')
plotter(log_t[lenght:], [P_der_Q[lenght:]], r'$ln(t)$', r'$\frac{dP_c(t)}{Q_0-Q(t)}$')
